...
class kinesisanalyticsTagger(object):
    def __init__(self, dryrun, verbose, role=None, region=None):
        self.dryrun = dryrun
        self.verbose = verbose
        self.role = role
        self.region = region
        self.kinesisanalytics = _client('kinesisanalytics', role=role, region=region)
    ...
    def tag(self, resource_arn, tags):
        ...
        resource_arn = f'application/{resource_arn}'
        ...
        if not self.dryrun:
            try:
                self._kinesisanalytics_create_tags(ResourceArn=file_system_id, Tags=aws_tags)
    ...
    def _kinesisanalytics_create_tags(self, **kwargs):
        return self.kinesisanalytics.tag_resource(**kwargs)