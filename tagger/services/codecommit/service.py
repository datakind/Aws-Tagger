...
class codecommitTagger(object):
    def __init__(self, dryrun, verbose, accesskey, secretaccesskey, role=None, region=None):
        ...
        self.region = region
        self.codecommit = _client('codecommit', accesskey=accesskey, secretaccesskey=secretaccesskey, role=role, region=region)
    ...
    def _codecommit_create_tags(self, **kwargs):
        return self.codecommit.tag_resource(**kwargs)