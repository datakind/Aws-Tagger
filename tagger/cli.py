...
@click.option('--accesskey', help='accesskey for authorized use (Username essentially)')
@click.option('--secretaccesskey', help='secret for authorized use (Password essentially')
...
def cli(dryrun, verbose, region, role, identifier, tag, resourcetype, accesskey, secretaccesskey, csv):
