...
## RoboMaker COMPLETED (NOT TESTED)
```
...
## Route53Resolver COMPLETED (NOT TESTED)
```
...
## StepFunctions COMPLETED (NOT TESTED)
```
...
## StorageGateway COMPLETED (NOT TESTED)
```
...
## Workspaces COMPLETED (NOT TESTED)
```
